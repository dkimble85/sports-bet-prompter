...
export const Route = createFileRoute('/nfl-prompts')({
  component: NFLPrompts,
})
...
AVOID: Do not recommend "trap" games, emotional "revenge" narratives, or bets based on small sample size hot streaks. Avoid heavy favorites unless the ML (Moneyline) offers clear Expected Value (EV). Avoid low hit-rate bets and highly volatile bets. Avoid touchdown-only parlays (unless requested).
              ...
              <div className='bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6'>
                ...
                <div className='mt-4 p-4 bg-slate-700/50 border border-slate-600 rounded-lg'>
                  ...
                  <p className='text-gray-400 text-sm mt-2 italic'>
                    "Using the identity above, analyze the NFL games
                    scheduled for Sunday, Feb 21. Focus on the AFC
                    East matchups."
                  </p>
                </div>
              </div>
